...
public class listar extends JFrame {
	...
	public listar() throws SQLException {
		...
		lblNewLabel_1.setBounds(30, 36, 46, 22);
		contentPane.add(lblNewLabel_1);
		
		
		
		JLabel lblNewLabel_2 = new JLabel("Telefone:");
		lblNewLabel_2.setBounds(30, 159, 57, 14);
		contentPane.add(lblNewLabel_2);
		
		telefone = new JTextField();
		telefone.setEditable(false);
		telefone.setBounds(111, 156, 236, 20);
		...
		buscar.setBounds(171, 117, 89, 23);
		...
		excluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					while(rs.next()){
						if(rs.getString("nome").equals(nome.getSelectedItem())) {
							bd_lista.delete(rs.getInt("idpessoa"));
						}
					}
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
		...
		excluir.setBounds(171, 69, 89, 23);
